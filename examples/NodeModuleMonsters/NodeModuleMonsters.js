...
var Base = require('./Base/Base.js'),
	TheUndead  = require('./TheUndead/TheUndead.js');

var vamp = new TheUndead.Vampire('dracula'); //dracula checking in...
zombie = new TheUndead.Zombie('garth'); //garth checking in... 
newBorn = new TheUndead.NewBornVampire('newby'); //newby checking in... 
human = new Base.Hero('charlie'); //charlie checking in... 
